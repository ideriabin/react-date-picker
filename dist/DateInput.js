...
var DateInput = /*#__PURE__*/function (_PureComponent) {
  ...
  function DateInput() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onClick", function (event) {
      if (event.target !== _this.dayInput.current && event.target !== _this.monthInput.current && event.target !== _this.yearInput.current) {
        // Wrapper was directly clicked
        var firstInput = event.currentTarget.querySelector('input[data-input]');
        focus(firstInput);
      }
    });
